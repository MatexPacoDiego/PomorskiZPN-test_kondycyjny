import style from "./Ekstraklasa.module.scss";
import headerImage from "../../assets/lucide-lab_soccer-pitch.png";
...
export default function Ekstraklasa() {
  ...
  return (
    <div className={style.container}>
      <header className={style.header}>
        <h3>
          <img src={headerImage} alt="boisko" />
          Ekstraklasa
        </h3>
        <main className={style.main}>
          ...
          <h2 className={style.trening}>
            ...
            Dla Sedziego <b className={style.bold}>Ekstraklasy</b>
          </h2>
          <br />
          <br />
